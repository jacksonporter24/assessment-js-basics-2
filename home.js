...
// arrow function is const greetUser ('username') => {}
...
function canWeDeliver(zipCode) {
    for (let arr = 0; arr < deliveryAreaZipCodes.length; arr++) {
...
//CODE HERE
var obj = deals[0]
    obj.title=obj.title.replace("15%", "10%")
console.log(deals)


// deals.forEach(function(obj, index){
//     obj.title=obj.title.replace("15%", "10%")
...
//CODE HERE
var obj1 = deals[1]
    obj1.desc = obj1.desc.replace("March", "April").trim()
    console.log(deals)